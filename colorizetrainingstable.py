...
Original file is located at
    https://colab.research.google.com/drive/15ZmvgBDqL21k_fo9H7oPWAjS9zNmMckO
...
if not torch.cuda.is_available():
    ...
    try:
        for i in map(lambda x: int(x), os.environ['CUDA_VISIBLE_DEVICES'].split(',')):
